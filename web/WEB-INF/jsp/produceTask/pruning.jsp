                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="pruningForm" action="/produce-task/addPruning">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="operateDate" id="operateDate" data-toggle="datetimepicker"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                            onclick="postProduceTaskData('pruningForm', 'pruningTbody', 'pruningModal')">
                                        添加
                                    </button>
                                </div>
                            </div>
