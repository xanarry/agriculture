    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="text-right">
                <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#addModal">采购${goods.name}</a>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/purchase/add" style="margin-bottom: 0em">
                                <input type="text" class="form-control" hidden id="goodsID" name="goodsID" value="${goods.ID}" placeholder="物资名" readonly>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-right">物资名</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${goods.name}" placeholder="物资名" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="totalPrice" name="totalPrice" readonly placeholder="总价">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-right">采购商</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seller" name="seller" value="${sessionScope.user.name}">
                                    </div>
                                </div>
                                <div class="form-group row">
