    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach items="${taskList}" var="task" varStatus="pos">
                    <tr>
                        <td class="text-center" style="vertical-align: middle">${task.ID}</td>
                        <td class="text-center" style="vertical-align: middle"><a href="/task/detail/${task.ID}" data-toggle="tooltip" data-placement="top" title="${task.item}">${task.name}</a></td>
                        <td class="text-center" style="vertical-align: middle">${task.productionArea}</td>
                        <td class="text-center" style="vertical-align: middle">${task.progress}</td>
                        <td class="text-center" style="vertical-align: middle">${task.state}</td>
                        <jsp:useBean id="deadline" class="java.util.Date"/>
                        <c:set target="${deadline}" property="time" value="${task.deadline}"/>
                        <td class="text-center" style="vertical-align: middle">
                            <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${deadline}"/>
                        </td>
                        ...
                        <td class="text-center" style="vertical-align: middle">${task.creator}</td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="post" action="/task/add" style="margin-bottom: 0em">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="productName" name="productName" placeholder="任务名, 不允许为空">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="productType" name="productType" placeholder="任务名, 不允许为空">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="productionArea" name="productionArea" placeholder="任务名, 不允许为空">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="productionAreaBlock" id="productionAreaBlock" multiple>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control" id="productDetail" name="productDetail" placeholder="任务名, 不允许为空"></textarea>
                                    </div>
                                </div>
